var add_cart = require('../user_model/get_user_cart_model');
var add_product = require('../admin_model/product_model');
...
exports.delete_data = async (req,res) => {
    ...
    var data = await add_cart.findByIdAndDelete(id).populate("p_id").populate("user_id");
...
exports.single_data = async (req,res) => {
    var id = req.params.id;
    var data = await add_cart.findById(id,req.body);
